                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select class="form-control" id="sexo" name="sexo" >
                                        ...
                                        @endif
                                        @if($aluno->sexo == 'F')
                                        <option value="{{$aluno->sexo}}">Feminino</option>
                                ...
                                <div class="col-md-3">
                                    <span>Idade</span>
                                    <input type="text" class="form-control" id="idade" name="idade" value="{{$aluno->idade}}">
                                </div>
                                <div class="col-md-3">
                                    <span>Altura (cm)</span>
                                ...
                                <div class="col-md-3">
                                    <span>Peso (kg)</span>
                                    <input type="text" class="form-control" id="peso" name="peso" value="{{$aluno->peso}}">
                                </div>
                                <div class="col-md-3">
                                    <span>TMB</span>
                                    <input type="text" class="form-control" id="tmb" name="tmb" value="{{$aluno->tmb}}">
                                </div>
